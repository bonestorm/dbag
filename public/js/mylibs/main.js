...
define(['db_interface','grid','input','help','menu','text_overlay','composer','slist','key'],function(DB_INTERFACE,GRID,INPUT,HELP,MENU,TEXT_OVERLAY,COMPOSER,SLIST,KEY){

    return function(){

        var OBJ = {
            canvas_obj: $('#canvasOne'),
            overlay_obj: $('#text_overlay')
        };
        ...
        var globs = {
            ...
            context: OBJ.canvas_obj.get(0).getContext('2d')//2d canvas context
        };
        ...
        function window_resize(){
            ...
            OBJ.canvas_obj.attr("width",new_dims.width+"px");
            OBJ.canvas_obj.attr("height",new_dims.height+"px");
            OBJ.overlay_obj.css("width",new_dims.width+"px");
            OBJ.overlay_obj.css("height",new_dims.height+"px");
            OBJ.refresh();
            OBJ.window_resizing = false;
        }
