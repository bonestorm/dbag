...
define(['base','input_title','table','input_dropdown'],function(BASE,INPUT_TITLE,TABLE,INPUT_DROPDOWN){
      ...
      function set_db_tab(dbs){
        ...
        if(_globs.db_interface["databases"].length > 0){
          OBJ.tabs["db"].set_to([//add an input for selecting the database to load
            new INPUT_TITLE(_globs,{title: "Pick a database to load",height: OBJ.input_height,callback: function(){alert('hi');}}),
            new INPUT_DROPDOWN(_globs,{
          ...
          OBJ.tabs["db"].set_to([//no databases found
            new INPUT_TITLE(_globs,{title: "No databases found",height: OBJ.input_height,callback: function(){alert('hi');}})
          ]);
        }
        OBJ.tab_footprint();
        OBJ.active_tab = "db";
    ...
    if(type == "tables"){
      ...
      if(table_names.length > 0){
        ...
        if(!all_placed && OBJ.active_tab == "tables"){
          ...
          tabs = [
            new INPUT_TITLE(_globs,{title: "Pick a table:",height: OBJ.input_height,callback: function(){alert('hi');}}),
            new INPUT_DROPDOWN(_globs,{
              data: table_names,
              height: OBJ.input_height,
        ...
        tabs = [
          new INPUT_TITLE(_globs,{title: "All tables placed",height: OBJ.input_height,callback: function(){alert('hi');}})
        ];
...
//          alert(f[start_table]);
          ...
          var tabs = [
            new INPUT_TITLE(_globs,{title: start_table+".",height: OBJ.input_height,callback: function(){alert('hi');}}),
            new INPUT_DROPDOWN(_globs,start_dropdown_options),
            new INPUT_TITLE(_globs,{title: "<-- joined to -->",height: OBJ.input_height}),
            new INPUT_TITLE(_globs,{title: end_table+".",height: OBJ.input_height,callback: function(){alert('hi');}}),
            new INPUT_DROPDOWN(_globs,end_dropdown_options)
          ];
      ...
      OBJ.tabs["join"].set_to([
        new INPUT_TITLE(_globs,{title: "loading field information",height: OBJ.input_height,callback: function(){alert('hi');}}),
      ]);
